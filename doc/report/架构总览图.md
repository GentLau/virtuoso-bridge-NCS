...
字段名与默认值读[中层配置文档](../中层/add-中层配置文档.md)；本版不做什么读[本版范围与明确不支持](add-本版范围与明确不支持.md)；总索引见 [Spec README](../../README.md)。
...
> 本图只是图说；**唯一口径见[2-并发设计 §2/§3](../中层/2-并发设计.md)**，数值见[中层配置文档](../中层/add-中层配置文档.md)。
