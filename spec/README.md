...
- **Normative 内容哈希**：`8c7a0ed293c1a2cd20f7c33a52985c9ff51bf0d45e6ac90db8fde6703ff38498`
...
| 多用户与注册 | Draft v29 | Normative | Draft v28（各步失败均可同一步重试；cancel 才释放） |
| 并发设计 | Draft v20 | Normative | Draft v19（重试决策单元术语统一为业务操作） |
| 顶层 | Draft v16 | Normative | Draft v15（不保存业务状态措辞） |
| 控制面与业务面 | Draft v18 | Normative | Draft v17（各步失败均可同一步重试；cancel 才释放） |
