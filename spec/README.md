...
- **Normative 内容哈希**：`2c7a2b42a55c1af44c9e4646a7f0680b608d53138e0b45c595d2c79dce30d342`
...
| 控制面与业务面 | Draft v12 | Normative | Draft v11（端口与工作路径改启动参数；工作路径新增 server.json，当前仅线程池参数） |
