...
- **Normative 内容哈希**：`bf2f9e898044a253679507efcd35c6711b8e64efb0393696c0765727664de3fd`
...
| 文档 | 版本 | 状态 | Supersedes |
|---|---|---|---|
| 四层整体架构与接口 | Draft v27 | Normative | Draft v26（query 的 token 改为 keyword-only，与业务接口一致） |
...
| 控制面与业务面 | Draft v11 | Normative | Draft v10（管理权限=内置单管理员 token 哈希；管理端点收编；控制端口默认 127.0.0.1；响应脱敏 token） |
