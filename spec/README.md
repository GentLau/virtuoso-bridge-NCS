...
> 版本：Release `SPEC-2026-09-22-r16`（送审修订版）
> 日期：2026-09-22
> 状态：Normative 基线（取代 r15）
> Supersedes：`SPEC-2026-09-22-r15`（`user update` 支持增改删各 role 用户组）
