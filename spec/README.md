...
> 版本：Release `SPEC-2026-09-23-r19`（送审修订版）
> 日期：2026-09-23
> 状态：Normative 基线（取代 r18）
> Supersedes：`SPEC-2026-09-23-r18`（`key_dir`/`key` 无缺省、remote 必填）
...
| 中层配置文档 | Draft v41 | Normative | Draft v40（`key_dir`/`key` 无缺省，remote role 必填） |
