...
- 当前规范：`spec/design-concepts/中层/add-中层配置文档.md:35-64,113-130,215-245`；`1-多用户与注册.md:107-117,131,141-147,296`；`1-四层整体架构与接口.md:42,239-253,271,290`；`日志返回设计标准.md:26`；`add-本版范围与明确不支持.md:16,23`。
