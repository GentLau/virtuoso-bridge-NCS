...
| split host / scratch / client isolation | 旧实现：`../../src_bak/virtuoso_bridge/transport/remote_roles.py`、`remote_paths.py`、`git show e7ae05d:docs/adr/0001-explicit-remote-host-roles.md`；当前口径：[多节点设计](../design-concepts/中层/3-路由设计.md) |
