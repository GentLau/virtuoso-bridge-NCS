...
Run with::
    ...
    PYTHONPATH=src python test/live/stress/http_mixed_stress_tb.py \
        --work-dir test/artifacts/env/reg-vb11 --remote-token vb-vblog \
        --out test/artifacts/http-mixed-stress.json
"""
