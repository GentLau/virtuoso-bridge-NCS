...
Run from Windows:  python test/role_split_cross_host.py
"""
...
def main() -> int:
    wd = override_work_dir_for_tests(Path(tempfile.mkdtemp(prefix="vb-split-")))
    ...
    out["file"] = {
        ...
        "remote": "/root/.virtuoso-bridge/cross/cross.bin",
    }
